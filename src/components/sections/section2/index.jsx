...
const Section2 = () => {
    return (
        <div className="bg-gradient-darkblue overflow-hidden relative -mt-20 flex justify-center items-center min-h-screen">
          <img className="absolute z-10 md:mt-[10%] md:w-[100%] ml-4 mt-55" src="/resource/background/air-terjun.svg" />
          <div className="absolute z-20 md:mt-[15%] ml-4 ">
